...
- Velocity-coherent extraction — [spec](docs/maths/proposal/20260220-velocity-coherent-foreground-extraction.md) | [plan](docs/lidar/future/velocity-coherent-foreground-extraction.md)
  - Project A: cluster-level velocity noise model (Phase 1)
  - Project B: two-stage velocity-split clustering (Phase 2)
  - Project C: Kalman-based track coasting (Phase 3)
  - Project D: sparse continuation scaling (Phase 4)
  - Project E: parallel foreground channel union (Phase 5)
  - Project F: log-likelihood fragment merge (Phase 6)
  - Project G: pipeline integration + validation (Phases 7-8)
...
- [#291] PR template design checklist — add DESIGN.md §9 UI/chart checklist to .github/PULL_REQUEST_TEMPLATE.md — [design doc §8.2](docs/plans/design-review-and-improvement-plan.md)
