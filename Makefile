...
build-mac:
	...
	@printf '// BuildInfo.swift\n// Auto-generated by make build-mac. Do not edit manually.\n\nenum BuildInfo {\n    static let gitSHA = "%s"\n    static let buildTime = "%s"\n}\n' \
		"$(GIT_SHA)" \
		"$(BUILD_TIME)" \
		> $(VISUALISER_DIR)/VelocityVisualiser/App/BuildInfo.swift
...
.PHONY: test test-go test-go-cov test-go-cov-pcap test-go-coverage-summary test-go-changed-coverage test-python test-python-cov tex-compare test-web test-web-cov test-docs-offline test-docs-offline-cov test-mac test-mac-cov coverage loc-coverage-chart
...
test-mac-cov:
	...
	@printf '// BuildInfo.swift\n// Auto-generated by make test-mac-cov. Do not edit manually.\n\nenum BuildInfo {\n    static let gitSHA = "%s"\n    static let buildTime = "%s"\n}\n' \
		"$(GIT_SHA)" \
		"$(BUILD_TIME)" \
		> $(MAC_DIR)/VelocityVisualiser/App/BuildInfo.swift
...
# LAYOUT: full (default) or auto — controls ERD grouping mode
LAYOUT ?= full
