...
**Status:** Proposal (breaking change — no backward compatibility)
**Date:** 2026-02-27
**Schema version:** `2`
...
[velocity-coherent foreground extraction](../data/math/proposals/20260220-velocity-coherent-foreground-extraction.md)
proposal introduces:
...
| -------------------------------------- | ------- | ------------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| `background_update_fraction`           | float64 | [background-grid-settling-maths.md](../data/math/background-grid-settling-maths.md) | Tunable                                                        |
...
| ------------------------------- | ------- | ------------------------------------------------------------ |
| `foreground_dbscan_eps`         | float64 | [clustering-maths.md](../data/math/clustering-maths.md)     |
| `foreground_min_cluster_points` | int     | DBSCAN MinPts                                                |
| `foreground_max_input_points`   | int     | Downsampling cap                                             |
| `height_band_floor`             | float64 | [ground-plane-maths.md](../data/math/ground-plane-maths.md) |
...
| Key                                   | Type    | Maths reference / description                                           | Source                                  |
| ------------------------------------- | ------- | ----------------------------------------------------------------------- | --------------------------------------- |
| `gating_distance_squared`             | float64 | [tracking-maths.md](../data/math/tracking-maths.md) — Mahalanobis gate | Tunable                                 |
...
See: [velocity-coherent-foreground-extraction.md §7](../data/math/proposals/20260220-velocity-coherent-foreground-extraction.md)
...
- [Velocity-Coherent Foreground Extraction](../data/math/proposals/20260220-velocity-coherent-foreground-extraction.md) — engine variants and config contract (§6)
- [ML Solver Expansion](../docs/lidar/architecture/ml-solver-expansion.md) — optimisation platform plan
- [Maths README](../data/math/README.md) — proposal roadmap (P1–P4)
- [Geometry-Coherent Tracking](../data/math/proposals/20260222-geometry-coherent-tracking.md) — P1 proposal (L5 geometry model)
