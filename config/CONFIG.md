...
```json
{
  ...
  "l3": {
    ...
    "ema_baseline_v1": {
      ...
      "movement_deviation_threshold": 1.5,
      "noise_bounds_threshold": 2.0,
      "settled_threshold": 50,
...
| `l3.ema_baseline_v1.movement_deviation_threshold`         | float64 | [GetMovementDeviationThreshold](../internal/config/tuning_accessors.go)        | Sustained-motion noise-deviation threshold (offline classifier). |
| `l3.ema_baseline_v1.noise_bounds_threshold`               | float64 | [GetNoiseBoundsThreshold](../internal/config/tuning_accessors.go)              | Reported within-noise-bounds threshold (offline classifier).     |
| `l3.ema_baseline_v1.settled_threshold`                    | int     | [GetSettledThreshold](../internal/config/tuning_accessors.go)                  | Settled-cell observation count (offline classifier).             |
