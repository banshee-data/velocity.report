...
```json
{
  ...
  "l3": {
    ...
    "ema_baseline_v1": {
      ...
      "sensor_movement_deviation_threshold": 1.5,
...
| `l3.ema_baseline_v1.sensor_movement_deviation_threshold`  | float64 | [GetSensorMovementDeviationThreshold](../internal/config/tuning_accessors.go)  | Sustained sensor-motion spread/noise ratio.     |
