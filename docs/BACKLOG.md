...
- [#290] (#11) Finish serial configuration rollout: ship device/baud auto-detect endpoints and validate a USB serial adapter plus a changed-setting reload. DB-backed startup, explicit apply/reload, operator workflow guidance, and the Pi/HAT validation pass are delivered: [implementation plan](plans/serial-configuration-implementation-plan.md) `M`
