...
- Homepage responsive GIF strategy — implement and document responsive GIF/MP4 strategies for VelocityVisualiser demo on homepage. [design doc](plans/homepage-responsive-gif-strategies.md) `S`
