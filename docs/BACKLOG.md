...
- Agent knowledge architecture — extract shared knowledge into `.github/knowledge/` modules, create `TENETS.md`, condense agent files to role-specific content, create platform-native agent definitions for both Copilot and Claude with automated drift detection — [design doc](plans/agent-claude-preparedness-review-plan.md) `L`
