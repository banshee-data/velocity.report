...
- [#498] `velocity-ctl upgrade` checksum verification: per-asset metadata sourced from `releases.json`, SHA-256 verified before install, prerelease + fallback logic tightened; shipped during the 0.5.1 pre-release cycle: [design doc](plans/deploy-rpi-imager-fork-plan.md) §4 step 2
