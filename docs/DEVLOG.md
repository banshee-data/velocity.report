...
- Updated version across all components via `set-version.sh 0.5.0 --all`.
...
- Created comprehensive ML Pipeline Roadmap document (`internal/lidar/docs/ml_pipeline_roadmap.md`).
