...
4. **All callers updated**: sub-packages (l1packets, monitor, visualiser, sweep) and external callers (internal/cmd/server, internal/db) import from layer packages directly.
