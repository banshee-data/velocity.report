...
**Next Phases:** See [Product Roadmap — LiDAR Pipeline Reference](../../ROADMAP.md#appendix-a-lidar-pipeline-reference) for Phases 4.0-4.3.
...
**Next Action:** Implement Phase 4.0 Analysis Run Infrastructure (see [`docs/ROADMAP.md`](../../ROADMAP.md#appendix-a-lidar-pipeline-reference))
...
- **[Product Roadmap — LiDAR Pipeline Reference](../../ROADMAP.md#appendix-a-lidar-pipeline-reference)** - Pipeline data flow, existing components, and deployment architecture
