...
- Vector scene map → **L4 Perception** (polygon features for ground, structures, volumes; derived from ground plane; see `docs/plans/lidar-architecture-vector-scene-map-plan.md`)
- Tracks → **L5 Tracks**
