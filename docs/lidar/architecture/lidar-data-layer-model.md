...
- Vector scene map → **L4 Perception** (polygon features for ground, structures, volumes; derived from ground plane; see `docs/lidar/architecture/vector-scene-map.md`)
- Tracks → **L5 Tracks**
