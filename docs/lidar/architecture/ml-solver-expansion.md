...
### 1.3 HINT plan status assessment ([docs/lidar/operations/hint-sweep-mode.md](../operations/hint-sweep-mode.md))
...
>
> See also:
> [`data/maths/proposals/20260220-velocity-coherent-foreground-extraction.md` §6](../../../data/maths/proposals/20260220-velocity-coherent-foreground-extraction.md)
