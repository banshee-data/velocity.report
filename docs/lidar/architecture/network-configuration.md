...
**Related:** [`HESAI_PACKET_FORMAT.md`](../../data/HESAI_PACKET_FORMAT.md), [`lidar_sidecar_overview.md`](./lidar_sidecar_overview.md), [`networking.md`](../../radar/architecture/networking.md)
