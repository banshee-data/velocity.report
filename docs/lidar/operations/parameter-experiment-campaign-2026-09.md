...
- **Scope:** Execute the backlog in [data/experiments/try/](../../../data/experiments/try) against the
  ...
  [state-estimation-phase01-corpus-baseline.md](state-estimation-phase01-corpus-baseline.md))
...
- **Related:** [lidar-parameter-tuning-optimisation-plan.md](../../plans/lidar-parameter-tuning-optimisation-plan.md)
  (evergreen design doc this campaign executes against),
  [lidar-heading-coherence-sprint-plan.md §5.2](../../plans/lidar-heading-coherence-sprint-plan.md)
  (harness notes, the disk-contention finding and its fix),
  [lidar-state-estimation-plan.md](../../plans/lidar-state-estimation-plan.md) (Phase 0/1 status).
