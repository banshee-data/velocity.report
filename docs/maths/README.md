...
- [OBB Heading Stability Review](proposals/obb-heading-stability-review.md) — **Partially Implemented**
...
- [Geometry-Coherent Track State](proposals/geometry-coherent-tracking.md)
...
- [Velocity-Coherent Foreground Extraction](proposals/velocity-coherent-foreground-extraction.md)
...
- [Ground Plane and Vector-Scene Maths](proposals/ground-plane-vector-scene-maths.md)
...
- [Reflective Sign and Static Surface Pose Anchors](proposals/reflective-sign-pose-anchor-maths.md)
...
- [Unify L3/L4 Settling](proposals/unify-l3-l4-settling.md)
...
**Source:** [geometry-coherent-tracking.md](proposals/geometry-coherent-tracking.md)
**Layer:** L5 tracking
...
[OBB heading stability review](proposals/obb-heading-stability-review.md)
become unnecessary once the geometry-coherent model replaces the guards.

### P2 — Velocity-Coherent Foreground Extraction

**Source:** [velocity-coherent-foreground-extraction.md](proposals/velocity-coherent-foreground-extraction.md)
...
**Source:** [ground-plane-vector-scene-maths.md](proposals/ground-plane-vector-scene-maths.md)
...
**Source:** [unify-l3-l4-settling.md](proposals/unify-l3-l4-settling.md)
...
**Source:** [reflective-sign-pose-anchor-maths.md](proposals/reflective-sign-pose-anchor-maths.md)
...
**Source:** [obb-heading-stability-review.md](proposals/obb-heading-stability-review.md)
