...
| `speed.mean_mph`   | `lidar_tracks.p50_speed_mps` × 2.237 (note: `avg_speed_mps` is retained as a running mean; the abstract schema uses the p50 per-track percentile as its representative value) | ✅                  |
