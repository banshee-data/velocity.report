...
| ----------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------- |
| `capabilitiesProvider`                                | [internal/api/](../../internal/api)                                   | Already imports only [internal/api](../../internal/api) |
| LiDAR validation helpers                              | [internal/config/](../../internal/config)                             | Tuning validation belongs with tuning types             |
| LiDAR networking helpers                              | [internal/lidar/server/](../../internal/lidar/server)                 | Port validation belongs with the UDP listener           |
| PCAP/visualiser callbacks                             | [internal/lidar/server/](../../internal/lidar/server)                 | Callback factories used by server pipeline              |
| `backgroundManagerBridge`                             | [internal/lidar/l9endpoints/](../../internal/lidar/l9endpoints)       | Bridges l3grid → l9endpoints types                      |
| HINT adapters                                         | [internal/lidar/sweep/](../../internal/lidar/sweep)                   | Bridge sqlite stores to sweep interfaces                |
| `runTransitsCommand` dispatch                         | [internal/db/](../../internal/db)                                     | Sits alongside `TransitCLI`                             |
| `resolvePrecompiledTeXRoot` + `configurePDFLaTeXFlow` | [internal/config/](../../internal/config)                             | Pure config resolution                                  |
| `legacyTuningConfig` + `migrateLegacyConfig`          | [internal/config/](../../internal/config)                             | Migration logic is config domain                        |
| `RunBackfillDB`                                       | [internal/lidar/storage/sqlite/](../../internal/lidar/storage/sqlite) | SQL belongs with its schema                             |
| `runPCAPEval`                                         | [internal/lidar/l3grid/](../../internal/lidar/l3grid)                 | Background settling evaluation                          |

No new packages are created. All destinations already exist.

## Scope

### Item 1: extract `capabilitiesProvider` to [internal/api/](../../internal/api)
...
homes in [internal/config/](../../internal/config) and [internal/lidar/server/](../../internal/lidar/server).

**Steps:**

1. Move `validateSupportedTuning`, `ensureSupportedTuning` to [internal/config/tuning_validate.go](../../internal/config/tuning_validate.go)
...
3. Move `tuningHashOrWarn`, config hash helpers to [internal/config/](../../internal/config)
4. Move `mustLoadValidatedPandarConfig`, `ringElevationLogMessage` to
   [internal/lidar/server/](../../internal/lidar/server)
5. Move PCAP/visualiser callbacks (`handlePCAPStartedVisualiser`,
   `publishPCAPProgress`, `pcapProgressCallback`) to [internal/lidar/server/](../../internal/lidar/server)
...
- [ ] Item 1: Extract `capabilitiesProvider` to [internal/api/](../../internal/api) (`S`)
- [ ] Item 2: Extract `lidar_helpers.go` to [internal/config/](../../internal/config) + [internal/lidar/server/](../../internal/lidar/server) (`M`)
- [ ] Item 3: Extract adapters from `radar.go` to [internal/lidar/](../../internal/lidar) (`M`)
- [ ] Item 4: Extract `runTransitsCommand` to [internal/db/](../../internal/db) (`M`)
- [ ] Item 5: Extract TeX flow config to [internal/config/](../../internal/config) (`S`)
- [ ] Item 6: Extract `config-migrate` logic to [internal/config/](../../internal/config) (`S`)
- [ ] Item 7: Extract `backfill_ring_elevations` SQL to [internal/lidar/storage/sqlite/](../../internal/lidar/storage/sqlite) (`S`)
- [ ] Item 8: Extract `settling-eval` orchestration to [internal/lidar/l3grid/](../../internal/lidar/l3grid) (`S`)
