...
Status: Planned
Purpose/Summary: lidar-architecture-av-range-image-format-alignment.
...
4. Internal: `docs/lidar/architecture/hesai_packet_structure.md` - Packet structure analysis
