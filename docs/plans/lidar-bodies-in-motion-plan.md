...
**Maths proposal:** to be written — `data/math/proposals/YYYYMMDD-bodies-in-motion-maths.md`
...
- Write maths proposal: `data/math/proposals/YYYYMMDD-bodies-in-motion-maths.md`
