...
**Maths index:** [data/math/README.md](../../data/math/README.md)
...
**Related maths docs:** [background-grid-settling-maths.md](../../data/math/background-grid-settling-maths.md) (L3 EMA settling), [ground-plane-maths.md](../../data/math/ground-plane-maths.md) (L4 surface estimation).
...
**Related maths doc:** [ground-plane-vector-scene-maths proposal](../../data/math/proposals/20260221-ground-plane-vector-scene-maths.md) § 3.1.
...
**Related maths docs:** [tracking-maths.md](../../data/math/tracking-maths.md) (L5 Kalman filter), [clustering-maths.md](../../data/math/clustering-maths.md) (DBSCAN spatial indexing).
...
**Design doc:** [lidar-bodies-in-motion-plan.md](lidar-bodies-in-motion-plan.md) expands this into a full implementation plan including sparse-cluster track linking and path prediction. **Maths proposal:** [bodies-in-motion-maths](../../data/math/proposals/) (to be written).
