...
**Layers:** L6 Objects
**Related:** [Metrics-First Data Science Plan](platform-data-science-metrics-first-plan.md), [Backlog](../BACKLOG.md), [Track Labelling, Ground Truth Evaluation & Label-Aware Auto-Tuning](lidar-track-labeling-auto-aware-tuning-plan.md), [Classification Maths](../../data/math/classification-maths.md)
