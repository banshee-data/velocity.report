...
- **Target:** v0.5.5-v2.0; scorecard and corpus contracts follow the headway critical path, and candidate models stay parked at v2.0 until the scorecard exists.
...
| Scorecard definition    | Promotion gate demands "the agreed scorecard"; no scorecard is defined anywhere in the repository                | High     | Phase 1, v0.5.5                                                |
| Class accuracy metric   | Absent. Detection is measured, classification is not                                                             | High     | Phase 1, v0.5.5                                                |
...
| Corpus availability     | Assumes fixed replay packs; 1 of 5 captured, labels unversioned                                                  | Medium   | Phase 2, v0.5.5                                                |
