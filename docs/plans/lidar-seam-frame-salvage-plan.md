...
**Milestone:** v0.6.3. Valuable alone — it fixes in-file packet loss, which is more common than
...
**Milestone:** v0.6.3. Depends on item 1; without the gate this hands tracking a holed frame.
