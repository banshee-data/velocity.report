...
| Frame time                              | Mean and p99 for the tracking stage specifically, on M1 (Pi 4 recorded separately in v0.6.x+)   | Lower                             |
...
Per-stage Pi 4 timing is deferred to v0.6.x+ as a target-hardware optimisation pass, not a Phase 0
...
Per-case Pi stage timings are deferred to v0.6.x+ as a target-hardware optimisation pass; M1
...
Per-stage Pi 4 timing is deferred to v0.6.x+ as a target-hardware optimisation pass, not a
...
v0.6.x+ deployment measurement, not a Phase 0 requirement. Six-state or IMM cost claims belong to
...
| Q5  | What is the real memory cost of point retention on M1 at peak cluster counts? (Pi 4 is a v0.6.x+ follow-on measurement, not a Phase 1 blocker)   | Instrument peak retained bytes across a full kirk0 replay at production DBSCAN parameters                                                                                                                                                                                                                                                                                                                                                                                                       | Phase 1                                                             |
...
- [x] Phase 0: current M1 per-stage timings published (see corpus baseline above); Pi 4 per-stage timings deferred to v0.6.x+ as a target-hardware optimisation pass, not a Phase 0 blocker
