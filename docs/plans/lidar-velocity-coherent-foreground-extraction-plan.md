...
> [`docs/maths/proposals/velocity-coherent-foreground-extraction.md`](../maths/proposals/velocity-coherent-foreground-extraction.md)
...
- [`docs/maths/proposals/velocity-coherent-foreground-extraction.md`](../maths/proposals/velocity-coherent-foreground-extraction.md) — Mathematical model and parameter tradeoffs
