...
| Target                 | Purpose                                                                                                                                                                                                                           |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `build-server-for-mac` | Cross-compile Go server for macOS ARM64 (`GOOS=darwin GOARCH=arm64 CGO_ENABLED=1`), output to `tools/visualiser-macos/VelocityVisualiser/Resources/velocity-report-server` via [./internal/cmd/server](../../internal/cmd/server) |
