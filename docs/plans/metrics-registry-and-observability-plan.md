...
- **Target:** v0.5.2 contract names and v0.5.3 report registration for following metrics; broader observability and Prometheus export follow independently
...
v0.5.2–v0.5.3 dependency; repo-wide Prometheus and unrelated metric migrations are not.
