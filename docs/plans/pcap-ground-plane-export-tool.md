...
- `docs/proposals/lidar/architecture/gps-ethernet-parsing.md`
...
1. **PCAP GPS** (if `--gps-from-pcap` enabled):
   - Parse GPS ethernet packets using `docs/proposals/lidar/architecture/gps-ethernet-parsing.md` spec
