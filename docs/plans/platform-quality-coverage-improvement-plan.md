...
`cmd/` packages are excluded from the 95.5% target (they are
...
| [internal/lidar/lidarbench](../../internal/lidar/lidarbench)     | ~300         | [internal/lidar/pipeline](../../internal/lidar/pipeline)        | **LOW**: PCAP processing + ML export pipeline; tightly coupled to build tags.                                                                          |
