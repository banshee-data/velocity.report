...
| Overlap with SSE backpressure work (#380, v0.5.8)                    | Medium     | Medium | The outstanding drop/notify policy touches the same fan-out; coordinate the non-lossy armed tap with that work so the two do not diverge                                                                                                                                                                    |
