...
> [frontend-consolidation.md](./frontend-consolidation.md) (LiDAR toggle dependency)
...
[frontend-consolidation.md](./frontend-consolidation.md).
...
[frontend-consolidation.md](./frontend-consolidation.md) Phase 0 — Capabilities
...
- [velocity.report frontend-consolidation.md](./frontend-consolidation.md) — LiDAR toggle UI dependency
...
| **LiDAR support**                     | Included (pcap build) but **disabled by default**                            | Users enable via settings dashboard; depends on [frontend-consolidation.md](./frontend-consolidation.md) |
