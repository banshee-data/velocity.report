...
- **Target:** v0.5.3 alongside provisional headway report aggregation
...
| [internal/lidar/lidarbench](../../internal/lidar/lidarbench)                                                                                                    | `SpeedStatistics` computes P50/P85/P95 over a population of track max speeds (correct usage), but uses `p95` not `p98`.                           | ⚠️ Rename to `p98` (Phase 3)              |
