...
| Deprecation log message          | [internal/cmd/server/radar.go](../../internal/cmd/server/radar.go), [cmd/tools/visualiser-server/main.go](../../cmd/tools/visualiser-server/main.go) | Removed | `legacy JSON decode path; replay may be slower` stripped from both replay log paths                                                                      |
