...
- **Purpose:** Compare VelocityVisualiser menu structure with Wireshark's proven menu design patterns to identify gaps, adopt relevant conventions, and align keyboard shortcuts where appropriate. (Qt XML, Wireshark 4.x)
