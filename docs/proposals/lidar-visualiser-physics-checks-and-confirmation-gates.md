...
Status: Proposed
Target Directory: docs/projects/lidar/visualiser/
Purpose/Summary: Define automatic physics checks and confirmation gates in the LiDAR visualiser to block implausible tracks from being confirmed.
...
- `web/src/lib/components/projects/lidar/TrackList.svelte`
- `web/src/lib/components/projects/lidar/TimelinePane.svelte`
