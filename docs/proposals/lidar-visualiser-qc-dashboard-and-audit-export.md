...
Purpose/Summary: Design a session-level QC dashboard and exportable audit logs for the LiDAR visualiser to support traceability and review governance.
...
- `web/src/routes/projects/lidar/tracks/+page.svelte`
- `web/src/lib/api.ts`
