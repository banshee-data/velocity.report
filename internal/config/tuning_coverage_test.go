...
func TestCommonAndVariantValidateErrors(t *testing.T) {
	...
	l3Tests := []struct {
		...
		{"movement deviation", func(cfg *L3Common) { cfg.SensorMovementDeviationThreshold = 0 }, "sensor_movement_deviation_threshold must be positive"},
...
func TestTuningConfigGettersAndActiveConfig(t *testing.T) {
	...
	if cfg.GetSensor() != cfg.L1.Sensor ||
		...
		cfg.GetSensorMovementDeviationThreshold() != cfg.L3.EmaBaselineV1.SensorMovementDeviationThreshold ||
