...
func (c *L3Common) Validate() error {
	...
	if c.SensorMovementDeviationThreshold <= 0 {
		return fmt.Errorf("sensor_movement_deviation_threshold must be positive, got %f", c.SensorMovementDeviationThreshold)
	}
