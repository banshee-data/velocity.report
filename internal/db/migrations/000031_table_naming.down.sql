-- L8 tuning
    ...
    ALTER TABLE lidar_tuning_sweeps
RENAME TO lidar_sweeps;
...
-- L8 replay family
   ...
   RENAME COLUMN replay_case_id TO scene_id;

    ALTER TABLE lidar_replay_evaluations
RENAME TO lidar_evaluations;

    ALTER TABLE lidar_replay_cases
   RENAME COLUMN replay_case_id TO scene_id;

    ALTER TABLE lidar_replay_cases
RENAME TO lidar_scenes;
...
-- L8 run family
    ...
    ALTER TABLE lidar_run_missed_regions
RENAME TO lidar_missed_regions;
...
-- L5 track children
    ...
    ALTER TABLE lidar_track_annotations
   RENAME COLUMN replay_case_id TO scene_id;

    ALTER TABLE lidar_track_annotations
RENAME TO lidar_labels;
