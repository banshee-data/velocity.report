...
RENAME TO lidar_track_observations;

    ALTER TABLE lidar_labels
RENAME TO lidar_track_annotations;

    ALTER TABLE lidar_track_annotations
   RENAME COLUMN scene_id TO replay_case_id;
...
RENAME TO lidar_run_records;
    ...
    ALTER TABLE lidar_missed_regions
