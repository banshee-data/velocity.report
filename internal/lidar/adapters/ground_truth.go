...
func matchTracks(reference, candidate []*sqlite.RunTrack) []TrackMatchResult {
...
func EvaluateGroundTruth(reference, candidate []*sqlite.RunTrack, weights GroundTruthWeights) *GroundTruthScore {
	...
	candTrackMap := make(map[string]*sqlite.RunTrack)
...
func NewGroundTruthEvaluator(store *sqlite.AnalysisRunStore, weights GroundTruthWeights) *GroundTruthEvaluator {
