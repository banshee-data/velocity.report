...
func ExportTrackPointCloud(track *l5tracks.TrackedObject, observationHistory []*sqlite.TrackObservation) ([]*TrackPointCloudFrame, error) {
...
func ExtractMetadata(track *l5tracks.TrackedObject, frames []*TrackPointCloudFrame) *TrackPointCloudMetadata {
	totalPoints := 0
	...
	qualityMetrics := l6objects.ComputeTrackQualityMetrics(track)
