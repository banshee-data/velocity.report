...
func TestLoadAnalysis(t *testing.T) {
	t.Run("valid analysis.json", func(t *testing.T) {
		...
		report := &AnalysisReport{
			...
			Tracks: []TrackDetail{
				{
					TrackID: "track-1", AvgSpeedMps: 8.4,
					MaxSpeedMps: 9.1,
				},
			},
		}
...
func TestCompareReportsOverlapping(t *testing.T) {
	...
	tracksA := []l9endpoints.Track{
		{
			TrackID: "track-1", AvgSpeedMps: 5.0,
			MaxSpeedMps:      6.0,
			ObservationCount: 10,
		...
		{
			TrackID: "track-2", AvgSpeedMps: 10.0,
			MaxSpeedMps:      12.0,
			ObservationCount: 20,
	...
	tracksB := []l9endpoints.Track{
		{
			TrackID: "track-b1", AvgSpeedMps: 5.5,
			MaxSpeedMps:      6.5,
			ObservationCount: 10,
		...
		{
			TrackID: "track-b2", AvgSpeedMps: 9.5,
			MaxSpeedMps:      11.0,
			ObservationCount: 18,
