...
func TestListRuns(t *testing.T) {
	...
	if firstRun["replay_case_name"] != "data" {
		t.Errorf("expected replay_case_name data, got %v", firstRun["replay_case_name"])
	}
...
func TestServer_HandleDeleteRunTrack_Success(t *testing.T) {
	sqlDB, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestServer_HandleDeleteRunTrack_NotFound(t *testing.T) {
	sqlDB, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestServer_HandleDeleteRunTrack_MethodNotAllowed(t *testing.T) {
	sqlDB, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestServer_HandleDeleteRun_Success(t *testing.T) {
	sqlDB, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestServer_HandleDeleteRun_NotFound(t *testing.T) {
	sqlDB, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestServer_HandleDeleteRun_MethodNotAllowed(t *testing.T) {
	sqlDB, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestServer_HandleDeleteRun_NoDB(t *testing.T) {
	ws := &Server{db: nil}
