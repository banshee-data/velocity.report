...
func (ws *Server) handleSweepStart(w http.ResponseWriter, r *http.Request) {
...
func (ws *Server) handleSweepStatus(w http.ResponseWriter, r *http.Request) {
	if ws.sweepRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "sweep runner not configured")
		return
	}
...
func (ws *Server) handleSweepStop(w http.ResponseWriter, r *http.Request) {
	if ws.sweepRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "sweep runner not configured")
		return
	}
...
func (ws *Server) handleAutoTune(w http.ResponseWriter, r *http.Request) {
...
func (ws *Server) handleAutoTuneStart(w http.ResponseWriter, r *http.Request) {
...
func (ws *Server) handleAutoTuneStatus(w http.ResponseWriter, r *http.Request) {
	if ws.autoTuneRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "auto-tune runner not configured")
		return
	}
...
func (ws *Server) handleAutoTuneStop(w http.ResponseWriter, r *http.Request) {
	if ws.autoTuneRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "auto-tune runner not configured")
		return
	}
...
func (ws *Server) handleAutoTuneSuspend(w http.ResponseWriter, r *http.Request) {
	if ws.autoTuneRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "auto-tune runner not configured")
		return
	}
...
func (ws *Server) handleAutoTuneResume(w http.ResponseWriter, r *http.Request) {
	if ws.autoTuneRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "auto-tune runner not configured")
		return
	}
...
func (ws *Server) handleAutoTuneSuspended(w http.ResponseWriter, r *http.Request) {
...
func (ws *Server) handleHINT(w http.ResponseWriter, r *http.Request) {
	if r.Method == http.MethodPost {
...
func (ws *Server) handleHINTStart(w http.ResponseWriter, r *http.Request) {
...
func (ws *Server) handleHINTStatus(w http.ResponseWriter, r *http.Request) {
	if ws.hintRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "HINT runner not configured")
		return
	}
...
func (ws *Server) handleHINTContinue(w http.ResponseWriter, r *http.Request) {
	if ws.hintRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "HINT runner not configured")
		return
	}
...
func (ws *Server) handleHINTStop(w http.ResponseWriter, r *http.Request) {
	if ws.hintRunner == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "HINT runner not configured")
		return
	}
...
func (ws *Server) handleListSweeps(w http.ResponseWriter, r *http.Request) {
	if ws.sweepStore == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "sweep store not configured")
		return
	}
...
func (ws *Server) handleGetSweep(w http.ResponseWriter, r *http.Request) {
	if ws.sweepStore == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "sweep store not configured")
		return
	}
...
func (ws *Server) handleSweepCharts(w http.ResponseWriter, r *http.Request) {
	if ws.sweepStore == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "sweep store not configured")
		return
	}
...
func (ws *Server) handleSweepExplain(w http.ResponseWriter, r *http.Request) {
	if ws.sweepStore == nil {
		ws.writeJSONError(w, http.StatusServiceUnavailable, "sweep store not configured")
		return
	}
