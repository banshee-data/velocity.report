...
// Use this for tests that need Config.DB.
...
func TestNewServer(t *testing.T) {
	...
	if server.stats != stats {
		t.Error("Server stats not set correctly")
	}

	if server.parsingEnabled != true {
		t.Error("Server parsingEnabled not set correctly")
	}

	if server.udpPort != 2369 {
		t.Error("Server udpPort not set correctly")
	}
}
...
func TestServer_ForwardingConfig(t *testing.T) {
	stats := NewPacketStats()
	...
	if !server.forwardingEnabled {
		t.Error("Server forwardingEnabled not set correctly")
	}

	if server.forwardAddr != "192.168.1.100" {
		t.Errorf("Server forwardAddr not set correctly: got %s, want 192.168.1.100", server.forwardAddr)
	}

	if server.forwardPort != 2370 {
		t.Errorf("Server forwardPort not set correctly: got %d, want 2370", server.forwardPort)
	}
...
func TestServer_DataSourceStatus(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:        ":0",
		Stats:          stats,
...
func BenchmarkServer_StatusHandler(b *testing.B) {
	stats := NewPacketStats()
...
func TestServer_HandleGridStatus_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleGridStatus_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleTrafficStats_NoStats(t *testing.T) {
	config := Config{
		Address:           ":0",
		Stats:             nil, // No stats
		UDPListenerConfig: network.UDPListenerConfig{Address: ":0"},
...
func TestServer_HandleTrafficStats_Success(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_HandleGridReset_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleGridReset_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleGridHeatmap_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleGridHeatmap_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleBackgroundGridPolar_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarDebugDashboard(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleTrafficChart_NoStats(t *testing.T) {
	config := Config{
		Address:           ":0",
		Stats:             nil,
		UDPListenerConfig: network.UDPListenerConfig{Address: ":0"},
...
func TestServer_HandleTrafficChart_Success(t *testing.T) {
	stats := NewPacketStats()
	stats.AddPacket(1000)
	stats.LogStats(true)
...
func TestServer_HandleBackgroundGridHeatmapChart_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleClustersChart_NoTrackAPI(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleTracksChart_NoTrackAPI(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleForegroundFrameChart_NoSnapshot(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportSnapshotASC_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportSnapshotASC_SnapshotIDNotImplemented(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportSnapshotASC_NoDB(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportNextFrameASC_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportNextFrameASC_NoFrameBuilder(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportForegroundASC_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportForegroundASC_NoSnapshot(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshots_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshots_NoDB(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshotsCleanup_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshotsCleanup_NoDB(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarStatus_Success(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarPersist_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarPersist_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshot_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshot_NoDB(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleAcceptanceMetrics_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleAcceptanceMetrics_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleAcceptanceReset_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleAcceptanceReset_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStart_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStart_WrongSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStart_MissingPCAPFile(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStop_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStop_NotInPCAPMode(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPResumeLive_NotInAnalysisMode(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleBackgroundGrid_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleBackgroundGrid_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleBackgroundRegions_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleBackgroundRegionsDashboard(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleTuningParams_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleTuningParams_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_WriteJSONError(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleStatus_NotFound(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleBackgroundGrid_WithManager(t *testing.T) {
...
func TestServer_HandleBackgroundRegions_WithManager(t *testing.T) {
...
func TestServer_HandleBackgroundRegionsDashboard_WithSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleAcceptanceMetrics_WithManager(t *testing.T) {
...
func TestServer_HandleAcceptanceMetrics_Debug(t *testing.T) {
...
func TestServer_HandleAcceptanceReset_WithManager(t *testing.T) {
...
func TestServer_HandleTuningParams_GET_WithManager(t *testing.T) {
...
func TestServer_HandleTuningParams_POST_WithManager(t *testing.T) {
	...
	// POST with JSON body
	body := `{"l3":{"ema_baseline_v1":{"noise_relative": 0.05, "enable_diagnostics": false}}}`
...
func TestServer_HandleGridReset_WithManager(t *testing.T) {
...
func TestServer_HandleGridStatus_WithManager(t *testing.T) {
...
func TestServer_HandleSettlingEval_MissingSensorID(t *testing.T) {
	server := NewServer(Config{
		Address:           ":0",
		Stats:             NewPacketStats(),
		UDPListenerConfig: network.UDPListenerConfig{Address: ":0"},
...
func TestServer_HandleSettlingEval_NoManager(t *testing.T) {
	server := NewServer(Config{
		Address:           ":0",
		Stats:             NewPacketStats(),
		UDPListenerConfig: network.UDPListenerConfig{Address: ":0"},
...
func TestServer_HandleSettlingEval_WithManager(t *testing.T) {
...
func TestServer_HandleGridHeatmap_WithManager(t *testing.T) {
...
func TestServer_HandleBackgroundGridPolar_WithManager(t *testing.T) {
...
func TestServer_HandleTrafficChart_WithManager(t *testing.T) {
...
func TestServer_HandleLidarPersist_WithManager_Additional(t *testing.T) {
...
func TestServer_HandleLidarSnapshots_Additional(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshotsCleanup_Additional(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPResumeLive_MissingSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportNextFrameASC(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleExportForegroundASC(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_DataSourceManager_Integration(t *testing.T) {
...
func TestServer_DataSourceManager_ErrorInjection(t *testing.T) {
	mockDSM := NewMockDataSourceManager()
...
func TestServer_RealDataSourceManager(t *testing.T) {
	// Test that Server creates RealDataSourceManager when none provided
	stats := NewPacketStats()
...
func TestServer_StartLiveListenerInternal(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_ResolvePCAPPath(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_LatestFgCounts(t *testing.T) {
...
func TestServer_HandleTuningParams_GET(t *testing.T) {
...
func TestServer_HandleTuningParams_POST(t *testing.T) {
	...
	body := `{"l3":{"ema_baseline_v1":{"closeness_multiplier": 0.5, "neighbour_confirmation_count": 3}}}`
...
func TestServer_HandleLidarPersist(t *testing.T) {
...
func TestServer_HandlePCAPStart_NoPCAPDir(t *testing.T) {
	stats := NewPacketStats()
	sensorID := "test-sensor"
	config := Config{
		Address:           ":0",
...
func TestServer_HandlePCAPStop_NotRunning(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_HandlePCAPResumeLive(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_HandleLidarSnapshots(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_HandleLidarSnapshot_NoID(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_HandleExportSnapshotASC(t *testing.T) {
	stats := NewPacketStats()
...
func TestServer_HandleBackgroundGridPolar(t *testing.T) {
...
func TestServer_ResetBackgroundGrid(t *testing.T) {
...
func TestServer_ResetBackgroundGrid_NoManager(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_ResetFrameBuilder(t *testing.T) {
...
func TestServer_ResetAllState(t *testing.T) {
...
func TestServer_StopPCAPInternal(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleChartClustersJSON_WithDB(t *testing.T) {
...
func TestServer_HandleBackgroundGridPolar_AdditionalCoverage(t *testing.T) {
...
func TestServer_HandleGridHeatmap_AdditionalCoverage(t *testing.T) {
...
func TestServer_HandleLidarSnapshot_GET(t *testing.T) {
...
func TestServer_HandleLidarSnapshot_DELETE(t *testing.T) {
...
func TestServer_HandleClustersChart_NoTrackDB(t *testing.T) {
...
func TestServer_HandleTracksChart_NoTrackDB(t *testing.T) {
...
func TestServer_HandleBackgroundGridHeatmapChart_WithManager(t *testing.T) {
...
func TestServer_HandleForegroundFrameChart_WithManager(t *testing.T) {
...
func TestServer_HandleLidarSnapshots_ListSaved(t *testing.T) {
...
func TestServer_HandleExportFrameSequenceASC(t *testing.T) {
...
func TestServer_HandleLidarSnapshotsCleanup_WithSensorID(t *testing.T) {
...
func TestServer_HandleBackgroundGrid_WithSensorID(t *testing.T) {
...
// TestServer_ResolvePCAPPath_WithRealFile tests PCAP path resolution with real file
func TestServer_ResolvePCAPPath_WithRealFile(t *testing.T) {
...
// TestServer_ResolvePCAPPath_EmptyFile tests PCAP path with empty filename
func TestServer_ResolvePCAPPath_EmptyFile(t *testing.T) {
	cwd, err := os.Getwd()
	if err != nil {
		t.Fatalf("Failed to get current directory: %v", err)
	}
...
// TestServer_ResolvePCAPPath_TraversalAttempt tests directory traversal protection
func TestServer_ResolvePCAPPath_TraversalAttempt(t *testing.T) {
	cwd, err := os.Getwd()
	if err != nil {
		t.Fatalf("Failed to get current directory: %v", err)
	}
...
// TestServer_ResolvePCAPPath_NonExistentFile tests PCAP path with non-existent file
func TestServer_ResolvePCAPPath_NonExistentFile(t *testing.T) {
	cwd, err := os.Getwd()
	if err != nil {
		t.Fatalf("Failed to get current directory: %v", err)
	}
...
// TestServer_HandlePCAPStart_WithRealFile tests PCAP start handler with real file
func TestServer_HandlePCAPStart_WithRealFile(t *testing.T) {
...
// TestServer_StartPCAPInternal tests the StartPCAPInternal method directly
func TestServer_StartPCAPInternal(t *testing.T) {
...
// TestServer_StartPCAPInternal_NoBaseContext tests StartPCAPInternal without base context
func TestServer_StartPCAPInternal_NoBaseContext(t *testing.T) {
...
// TestServer_StartPCAPInternal_AlreadyRunning tests starting PCAP when one is already running
func TestServer_StartPCAPInternal_AlreadyRunning(t *testing.T) {
...
// TestServer_HandlePCAPStop_Success tests successful PCAP stop
func TestServer_HandlePCAPStop_Success(t *testing.T) {
...
// TestServer_HandlePCAPResumeLive_Success tests resuming live after PCAP
func TestServer_HandlePCAPResumeLive_Success(t *testing.T) {
...
// TestServer_StartPCAPInternal_RealtimeMode tests PCAP with realtime mode
func TestServer_StartPCAPInternal_RealtimeMode(t *testing.T) {
...
// TestServer_HandleBackgroundGridPolar_WithPCAPData tests polar chart with PCAP-populated data
func TestServer_HandleBackgroundGridPolar_WithPCAPData(t *testing.T) {
...
// TestServer_HandleTuningParams_POST_Complete tests setting tuning params
func TestServer_HandleTuningParams_POST_Complete(t *testing.T) {
	sensorID := "test-params-post-" + time.Now().Format("150405")
	cleanup := setupTestBackgroundManager(t, sensorID)
	defer cleanup()
	...
	body := `{"l3":{"ema_baseline_v1":{"noise_relative": 0.05, "safety_margin_metres": 0.5}}}`
	req := httptest.NewRequest(http.MethodPost, "/api/lidar/background/params?sensor_id="+sensorID, strings.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	rec := httptest.NewRecorder()
...
// TestServer_HandleChartClustersJSON tests clusters chart endpoint
func TestServer_HandleChartClustersJSON_WithManager(t *testing.T) {
...
// TestServer_HandleClustersChart_WithManager tests HTML clusters chart
func TestServer_HandleClustersChart_Complete(t *testing.T) {
...
// TestServer_HandleForegroundFrameChart_WithManager tests foreground frame chart
func TestServer_HandleForegroundFrameChart_Complete(t *testing.T) {
...
// TestServer_HandleLidarSnapshot_GET_Complete tests getting a specific snapshot
func TestServer_HandleLidarSnapshot_GET_Complete(t *testing.T) {
	sensorID := "test-snapshot-get-" + time.Now().Format("150405")
	cleanup := setupTestBackgroundManager(t, sensorID)
	defer cleanup()
...
// TestServer_HandleLidarSnapshots_GET_List tests listing snapshots
func TestServer_HandleLidarSnapshots_GET_List(t *testing.T) {
	sensorID := "test-snapshots-list-" + time.Now().Format("150405")
	cleanup := setupTestBackgroundManager(t, sensorID)
	defer cleanup()
...
// TestServer_HandleExportFrameSequenceASC_WithManager tests frame sequence export
func TestServer_HandleExportFrameSequenceASC_Complete(t *testing.T) {
...
// TestServer_HandleLidarPersist_Complete tests persist endpoint
func TestServer_HandleLidarPersist_Complete(t *testing.T) {
	sensorID := "test-persist-" + time.Now().Format("150405")
	cleanup := setupTestBackgroundManager(t, sensorID)
	defer cleanup()
...
// TestServer_StartPCAPInternal_WithDebugRange tests PCAP with debug range parameters
func TestServer_StartPCAPInternal_WithDebugRange(t *testing.T) {
...
// TestServer_HandleBackgroundGrid_Complete tests background grid endpoint
func TestServer_HandleBackgroundGrid_Complete(t *testing.T) {
	sensorID := "test-bg-grid-" + time.Now().Format("150405")
	cleanup := setupTestBackgroundManager(t, sensorID)
	defer cleanup()
...
// TestServer_IsPCAPInProgress tests PCAP progress check
func TestServer_IsPCAPInProgress_Complete(t *testing.T) {
...
func TestServer_SetTracker(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
// Tests requiring DB setup removed - Config.DB requires *db.DB not *sql.DB

// ====== handleTuningParams additional tests ======

func TestServer_HandleTuningParams_GET_Pretty(t *testing.T) {
...
func TestServer_HandleTuningParams_POST_WithTracker(t *testing.T) {
	...
	body := strings.NewReader(`{"l5":{"cv_kf_v1":{"gating_distance_squared": 25.0, "process_noise_pos": 0.5, "max_tracks": 77}}}`)
...
func TestServer_HandleTuningParams_POST_InvalidMaxTracks(t *testing.T) {
...
func TestServer_HandleTuningParams_POST_InvalidDeletedTrackGracePeriod(t *testing.T) {
...
func TestServer_HandleTuningParams_POST_UpdatesClassifierMinObservations(t *testing.T) {
...
func TestServer_HandleChartClustersJSON_NoTrackAPI(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleChartClustersJSON_WithActualDB(t *testing.T) {
...
func TestServer_HandleChartClustersJSON_WithTimeParams(t *testing.T) {
	wrappedDB, cleanup := setupTestDBWrapped(t)
	defer cleanup()
...
func TestServer_HandleLidarSnapshots_WithDB(t *testing.T) {
	wrappedDB, cleanup := setupTestDBWrapped(t)
	defer cleanup()
...
func TestServer_HandleLidarSnapshotsCleanup_WithDB(t *testing.T) {
	wrappedDB, cleanup := setupTestDBWrapped(t)
	defer cleanup()
...
func TestServer_SetTracker_WithDB(t *testing.T) {
	wrappedDB, cleanup := setupTestDBWrapped(t)
	defer cleanup()
...
func TestServer_HandleClustersChart_WithDB_AndParams(t *testing.T) {
	wrappedDB, cleanup := setupTestDBWrapped(t)
	defer cleanup()
...
func TestServer_HandleTracksChart_WithDB_AndParams(t *testing.T) {
	wrappedDB, cleanup := setupTestDBWrapped(t)
	defer cleanup()
...
func TestServer_HandleLidarSnapshot_NoDBExtra(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleLidarSnapshot_WithDB_MissingID(t *testing.T) {
	wrappedDB, cleanup := setupTestDBWrapped(t)
	defer cleanup()
...
func TestServer_HandleForegroundFrameChart_NoManagerExtra(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStop_NoSensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStop_WrongSensorIDExtra(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandlePCAPStop_FormPost(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_HandleBackgroundGridPolar_WithMaxPoints(t *testing.T) {
...
func TestServer_UpdateLatestFgCounts_EmptySensorID(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_UpdateLatestFgCounts_NoSnapshot(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
...
func TestServer_GetLatestFgCounts_ReturnsCopy(t *testing.T) {
	stats := NewPacketStats()
	config := Config{
		Address:           ":0",
		Stats:             stats,
