...
// comparison histogram. It is rendered full-width in the overview section, so
// it is taller than the single histogram to accommodate the x-axis label and
// legend box without crowding.
