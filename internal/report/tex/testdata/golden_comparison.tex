...
% Caption styling — monospace, small, no bold (matches hand-built table captions)
\captionsetup{font=small,labelfont=tt,textfont=tt}
...
\begin{itemize}
  ...
  \item \textbf{Period (t1):} 2024-01-01 \textemdash{} 2024-01-31
  \item \textbf{Period (t2):} 2024-02-01 \textemdash{} 2024-02-28
...
\hline
p50 & 25.00 mph & 26.00 mph & +6.1% \\
p85 & 30.00 mph & 31.00 mph & +4.0% \\
p98 & 35.00 mph & 36.00 mph & +2.3% \\
Max & 42.00 mph & 45.00 mph & +6.9% \\
Count & 1,000 & 900 & \\
\hline
\end{tabular}
\end{center}
...
Units: & \texttt{mph} \\
Min speed: & \texttt{0.0 mph} \\
Source (t1): & \texttt{radar} \\
Source (t2): & \texttt{radar_objects} \\
...
\rowcolors{0}{}{}
\par\vspace{2pt}
\noindent\makebox[\linewidth]{{\ttfamily\small Detailed Data}}
}
