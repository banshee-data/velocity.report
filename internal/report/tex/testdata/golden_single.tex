...
\fancyfoot[L]{\small 2024-01-01 to 2024-01-31}
...
\begin{itemize}
  ...
  \item \textbf{Period:} 2024-01-01 to 2024-01-31
...
\noindent
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.55\linewidth}>{\raggedleft\arraybackslash}p{0.42\linewidth}@{}}
{\sffamily\bfseries Metric} & {\sffamily\bfseries Value} \\
\hline
p50 Velocity & 25.00 mph \\
p85 Velocity & 30.00 mph \\
p98 Velocity & 35.00 mph \\
Max Velocity & 42.00 mph \\
\hline
\end{tabular}
\rowcolors{0}{}{}
\par\vspace{2pt}
...
Timezone: & \texttt{UTC} \\
Start time: & \texttt{2024-01-01T00:00:00Z} \\
End time: & \texttt{2024-01-31T23:59:59Z} \\
