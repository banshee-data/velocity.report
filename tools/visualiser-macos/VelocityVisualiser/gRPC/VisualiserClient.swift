            ...
            frame.tracks = TrackSet(
                ...
                tracks: proto.tracks.tracks.map { t in
                    Track(
                        ...
                        intensityMeanAvg: t.intensityMeanAvg, medianSpeedMps: t.medianSpeedMps,
                        peakSpeedMps: t.peakSpeedMps, p85SpeedMps: t.p85SpeedMps,
                        p98SpeedMps: t.p98SpeedMps, classLabel: objectClassLabel(t.objectClass),
