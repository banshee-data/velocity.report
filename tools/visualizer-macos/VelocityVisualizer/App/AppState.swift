// AppState.swift
// Global application state for the Velocity Visualizer.
//
// This class manages:
...
class AppState: ObservableObject {
    ...
    private var grpcClient: VisualizerClient?
    ...
    func connect() {
        ...
        // grpcClient = VisualizerClient(address: serverAddress)
    ...
    func seek(to progress: Double) {
        ...
        let targetTimestamp = logStartTimestamp + Int64(Double(logEndTimestamp - logStartTimestamp) * progress)
        // TODO: Send Seek RPC
    ...
    func onFrameReceived(_ frame: FrameBundle) {
        ...
        if !isLive && logEndTimestamp > logStartTimestamp {
            let progress = Double(currentTimestamp - logStartTimestamp) / Double(logEndTimestamp - logStartTimestamp)
