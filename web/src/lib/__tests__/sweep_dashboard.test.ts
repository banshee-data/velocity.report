...
function setupDOM(): void {
	...
	document.body.innerHTML = [
		...
		'<div id="btn-running-actions" style="display:none">',
		'  <button id="btn-stop" style="display:none">Stop Sweep</button>',
		'  <button id="btn-suspend" style="display:none">Suspend</button>',
		'</div>',
		'<button id="btn-resume" style="display:none">Resume Sweep</button>',
